...
EOF
  ...
  whiptail --backtitle "HomeLab YuxTec" --msgbox --title "PVE8 CEPH PACKAGE REPOSITORIES" "The 'Ceph Package Repositories' provides access to both the 'no-subscription' and 'enterprise' repositories." 10 58
...
EOF
  ...
  whiptail --backtitle "HomeLab YuxTec" --msgbox --title "PVE8 TEST" "The 'pvetest' repository can give advanced users access to new features and updates before they are officially released (Disabled)." 10 58
