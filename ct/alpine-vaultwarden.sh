...
function update_script() {
  ...
  while true; do
    CHOICE=$(
      whiptail --backtitle "HomeLab YuxTec" --title "SUPPORT" --menu "Select option" 11 58 2 \
    ...
    1)
      ...
      ;;
    2)
      if NEWTOKEN=$(whiptail --backtitle "HomeLab YuxTec" --passwordbox "Setup your ADMIN_TOKEN (make it strong)" 10 58 3>&1 1>&2 2>&3); then
