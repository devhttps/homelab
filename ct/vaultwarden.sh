...
function update_script() {
  ...
  UPD=$(whiptail --backtitle "HomeLab YuxTec" --title "SUPPORT" --radiolist --cancel-button Exit-Script "Spacebar = Select" 11 58 3 \
  ...
  if [ "$UPD" == "3" ]; then
    if NEWTOKEN=$(whiptail --backtitle "HomeLab YuxTec" --passwordbox "Set the ADMIN_TOKEN" 10 58 3>&1 1>&2 2>&3); then
